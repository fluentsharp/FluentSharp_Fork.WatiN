...
namespace FluentSharp.Watin
{
    ...
    {
        //todo: fix ascx_CaptchaQuestion was not in BCL
        /*
    ...
    public static class WatiN_IE_ExtensionMethods_WinForms
    {
    	...
    	public static WatiN_IE add_IE(this Form_Control control)
    	{
            try
            {
    	...
    	public static WatiN_IE add_IE_with_NavigationBar(this Form_Control control)
    	{            
    	...
    	public static WatiN_IE add_NavigationBar(this WatiN_IE watinIe, Form_Control control)
    	{
            if (watinIe.isNull())
                return watinIe;
    ...
    //using System.Threading
						...
						///	()=>{ 
									...
									//sync.WaitOne(2000);
									//"after waitOne()".debug();
		public static string jsFormat(this Form_Control tempHostControl, string codeToFormat)									
		{
			return tempHostControl.formatJsCode(codeToFormat);			
		}
		
		public static string formatJsCode(this Form_Control tempHostControl, string codeToFormat)
		{			
